...
(() => {
    ...
    function __webpack_require__(e) {
        ...
        return i[e].call(_.exports, _.exports, __webpack_require__),
        _.exports
    }
    ...
    // Captura global de erros relacionados a ChunkLoadError
    window.addEventListener('error', function(event) {
        if (event.message && event.message.includes('ChunkLoadError')) {
            console.warn('Chunk falhou, mas o site continuará funcionando:', event.message);
        }
    });
})();
